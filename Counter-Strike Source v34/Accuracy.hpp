...
namespace Feature
{
	...
	public:
		...
		bool				CanPenetrate( const Vector3& vStart, const Vector3& vEnd, int iMinDamage, int* pDamageOut = nullptr, int* pHitbox = nullptr, int* pHitgroup = nullptr, C_BaseEntity** ppEnt = nullptr );
	};
}